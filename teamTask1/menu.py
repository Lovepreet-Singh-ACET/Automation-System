...
####################### Hadoop installation ############################
    if had_r == 2:
        ...
        a = input("Enter ip of system where you want install hadoop: ")
        os.system("scp /home/love/Downloads/hadoop-1.2.1-1.x86_64.rpm  root@{}:/root/".format(a))
        #os.system("ssh root@{} echo 3 > /proc/sys/vm/drop_caches".format(a))
        o = subprocess.getoutput("ssh root@{} rpm -ivh --force /root/hadoop-1.2.1-1.x86_64.rpm  ".format(a))
        print(o[0:250])
